...
# a `PartitionedGraph`.
function NamedGraphs.position_graph_type(type::Type{<:PartitionsGraphView{V,G}}) where {V,G<:PartitionedGraph{V}}
...
for f in [
  ...
  @eval begin
    function $f(g::PartitionsGraphView{V,G}, args...; kwargs...) where {V,G<:PartitionedGraph{V}}
