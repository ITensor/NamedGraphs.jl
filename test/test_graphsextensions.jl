...
using NamedGraphs: NamedDiGraph, NamedEdge, NamedGraph, TreeGraph, add_edge, add_edges,
    add_edges!, all_edges, arrange_edge, arranged_edges, binary_arborescence, child_edges,
    child_vertices, convert_vertextype, degrees, directed_graph, directed_graph_type,
    disjoint_union, distance_to_leaves, forest_cover_edge_sequence, has_edges,
    has_leaf_neighbor, has_vertices, incident_edges, indegrees, is_arborescence,
    is_arranged, is_binary_arborescence, is_cycle_graph, is_ditree, is_edge_arranged,
    is_leaf_edge, is_leaf_vertex, is_path_graph, is_root_vertex, is_rooted, is_self_loop,
    leaf_vertices, minimum_distance_to_leaves, named_path_digraph, named_path_graph,
    next_nearest_neighbors, non_leaf_edges, outdegrees, permute_vertices, rem_edge,
    rem_edges, rem_edges!, rename_vertices, root_vertex, similar_dataless_graph,
    similar_graph, subgraph, tree_graph_node, undirected_graph, undirected_graph_type,
...
@testset "Graphs.jl extensions" begin
