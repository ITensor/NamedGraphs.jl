...
using NamedGraphs: NamedGraphs, AbstractNamedGraph, NamedDiGraph, NamedEdge, NamedGraph,
    add_vertices, eccentricities, edgeless_graph, empty_graph, encoded_graph, named_grid,
    named_path_graph, rem_vertices, rename_vertices, similar_dataless_graph, similar_graph,
    subgraph
