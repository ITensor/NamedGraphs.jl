...
using NamedGraphs: NamedGraphs, AbstractNamedGraph, NamedDiGraph, NamedGraph, encode_graph
...
NamedGraphs.encode_graph(g::TestGraph) = encode_graph(g.graph)
...
@testset "AbstractNamedGraph equality" begin
    ...
    add_edge!(ng2, "B" => "D")
    add_edge!(ng2, "C" => "D")
    @test NamedGraphs.encode_graph(ng1) != NamedGraphs.encode_graph(ng2)
    @test ng1 == ng2
    rem_edge!(ng2, "B" => "A")
    @test ng1 != ng2
    ...
    @test NamedGraphs.encode_graph(ndg1) != NamedGraphs.encode_graph(ndg2)
    @test ndg1 == ndg2
    ...
    @test NamedGraphs.encode_graph(nddg1) != NamedGraphs.encode_graph(nddg2)
    @test nddg1 == nddg2
