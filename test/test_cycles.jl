...
using NamedGraphs: degree, edge_subgraph, is_connected, leafless_edge_induced_subgraphs,
    named_comb_tree, named_grid, named_hexagonal_lattice_graph, rem_vertex
