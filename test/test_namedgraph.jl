...
using NamedGraphs.GraphsExtensions: GraphsExtensions, boundary_edges, boundary_vertices,
    ...
    eccentricities, edge_subgraph, has_vertices, incident_edges, indegrees, inner_boundary_vertices,
...
using NamedGraphs.NamedGraphGenerators: named_binary_tree, named_grid, named_path_graph, named_hexagonal_lattice_graph
...
@testset "NamedGraph" begin
    @testset "Basics" begin
        ...
        @test all([e ∈ edges(g) for e in es])
