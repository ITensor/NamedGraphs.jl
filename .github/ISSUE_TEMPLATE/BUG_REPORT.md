---
name: NamedGraphs.jl bug report
about: Create a bug report to help us improve NamedGraphs.jl
...
[YOUR OUTPUT HERE]
```
 - Output from `using Pkg; Pkg.status("NamedGraphs")`:
```julia
julia> using Pkg; Pkg.status("NamedGraphs")
[YOUR OUTPUT HERE]
```
